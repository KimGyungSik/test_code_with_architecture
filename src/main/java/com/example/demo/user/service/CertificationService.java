...
public class CertificationService{
    ...
    public String generateCertificationUrl(long userId, String certifiactionCode) {
        return "http://localhost:8080/api/users/" + userId + "/verify?certificationCode=" + certifiactionCode;
    }
}
